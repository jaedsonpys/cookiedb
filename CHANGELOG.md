...
- [CookieDB 4.3.0 in PyPi](https://pypi.org/project/cookiedb/4.3.0/)
- [CookieDB 4.3.0 in GitHub Release](https://github.com/jaedsonpys/cookiedb/releases/tag/v4.3.0)

## Features

- [`375c8f8`](https://github.com/jaedsonpys/cookiedb/commit/375c8f8): Accepting keys of any size for encryption;
- [`9238d99`](https://github.com/jaedsonpys/cookiedb/commit/9238d99): Using base64 keys generated by Fernet if available.